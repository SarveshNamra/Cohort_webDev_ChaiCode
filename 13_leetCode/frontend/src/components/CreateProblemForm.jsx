...
const CreateProblemForm = () => {
    ...
    return (
        <div className='relative min-h-screen container mx-auto py-8 px-4 max-w-7xl'>
          {/* Background Decorations */}
          <div className="pointer-events-none absolute -top-40 -left-40 w-[500px] h-[500px] bg-primary/30 rounded-full blur-[120px]" />
          <div className="pointer-events-none absolute top-1/2 -translate-y-1/2 -right-40 w-[400px] h-[400px] bg-secondary/30 rounded-full blur-[120px]" />
          <div className="pointer-events-none absolute bottom-0 left-1/4 w-[300px] h-[300px] bg-accent/20 rounded-full blur-[100px]" />

        <div className="relative p-[1px] rounded-2xl bg-gradient-to-r from-primary/40 via-secondary/40 to-accent/40">
