...
const ProblemTable = ({problems}) => {
    ...
    const allTags = useMemo(() => {
      ...
      const tagsSet = new Set(); // Initialize a Set to store unique tags
      problems.forEach((p) => p.tags?.forEach((t) => tagsSet.add(t))); // Add each tag to the Set
      
      return Array.from(tagsSet); // Convert the Set back to an array and return
    }, [problems]);
